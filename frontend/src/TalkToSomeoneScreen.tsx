    ...
    <div className="tts-row">
      ...
      <div className="tts-col-right">
        <div className="tts-phone-wrap">
          ...
          <div
            className={`tts-deco tts-d1 tts-deco-size ${a ? 'tts-anim-pop' : ''}`}
            style={{ animationDelay: '0.75s' }}
          >
            <img
              src="/corazonizquierda.png"
              alt=""
              className={mounted ? 'tts-fl-1' : ''}
            />
          </div>

          <div
            className={`tts-deco tts-d2 tts-deco-size ${a ? 'tts-anim-pop' : ''}`}
            style={{ animationDelay: '0.9s' }}
          >
            <img
              src="/carta.png"
              alt=""
              className={mounted ? 'tts-fl-2' : ''}
            />
          </div>

          <div
            className={`tts-deco tts-d3 tts-deco-size ${a ? 'tts-anim-pop' : ''}`}
            style={{ animationDelay: '1.05s' }}
          >
            <img
              src="/carta.png"
              alt=""
              className={mounted ? 'tts-fl-3' : ''}
            />
          </div>

          <div
            className={`tts-deco tts-d4 tts-deco-size ${a ? 'tts-anim-pop' : ''}`}
            style={{ animationDelay: '1.2s' }}
          >
            <img
              src="/corazonderecha.png"
              alt=""
              className={mounted ? 'tts-fl-4' : ''}
            />
          </div>
        </div>
      </div>
