...
const columns = [
  ...
  {
    title: "Compañía",
    links: ["Sobre nosotros", "Blog", "Contacto", "Prensa"],
  },
  {
    title: "Soporte",
    links: ["Centro de ayuda", "Comunidad", "FAQ", "WhatsApp"],
  },
  {
    title: "Legal",
...
const socialIcons = [
  ...
  {
    label: "TikTok",
    path: "M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.46V13a8.28 8.28 0 005.58 2.17V11.7a4.83 4.83 0 01-3.77-1.24V6.69h3.77z",
  },
  {
    label: "LinkedIn",
  ...
  return (
    <footer className="relative w-full bg-[#0F172A] overflow-hidden">
      <img
        src="/huella.png"
        alt=""
        className="absolute top-20 right-[8%] w-16 h-16 opacity-[0.025] rotate-12 brightness-0 invert pointer-events-none select-none"
      />
      <img
        src="/huella.png"
        alt=""
        className="absolute bottom-24 left-[5%] w-12 h-12 opacity-[0.02] -rotate-12 brightness-0 invert pointer-events-none select-none"
      />
      ...
      <div className="w-full max-w-[1800px] mx-auto px-6 sm:px-10 lg:px-40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-4 flex flex-col">
              ...
              <p className="font-body text-sm text-[#94A3B8] leading-relaxed max-w-xs mb-8">
                El ecosistema que conecta a dueños de mascotas con los
                mejores profesionales y negocios de su zona. Todo en un
                solo lugar, sin fricción.
              </p>
              ...
              <div className="flex items-center gap-3">
                {socialIcons.map((s, i) => (
                  ...
                  >
                    <svg
                      className="w-4 h-4 text-[#64748B] group-hover:text-[#67D1E3] transition-colors"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                      <path d={s.path} />
                ...
                <ul className="flex flex-col gap-3.5">
                  {col.links.map((link, li) => (
                    <li key={li}>
                      <a
                        href="#"
                        className="font-body text-sm text-[#64748B] hover:text-[#67D1E3] transition-colors duration-200"
                      >
                        {link}
                      </a>
                    </li>
        ...
        <div className="py-7 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-body text-xs text-[#475569]">
            © {new Date().getFullYear()} Petlia. Todos los derechos
            reservados.
          </p>
          <div className="flex items-center gap-2">
            <span className="font-body text-xs text-[#475569]">
              Hecho con
            </span>
            <svg
